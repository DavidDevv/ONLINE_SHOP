  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index">
        ...
        <div class="sidebar-brand-text mx-3">AKMJ STORE 69</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
             <ul class="nav navbar-nav navbar-right">
               <li>
               <?php 
               $keranjang = '<i class="fas fa-shopping-cart text-danger"></i> '.$this->cart->total_items
               ().      'items' 
               ?>
               ...
               <ul class="nav navbar-nav navbar-right">
                ...
                <?php if($this->session->userdata('username')){ ?>
                  <li><div class="text-gray">Selamat Datang<i class="fas fa-user text-danger"></i> <?php echo $this->session->userdata    ('username') ?></div></li>
